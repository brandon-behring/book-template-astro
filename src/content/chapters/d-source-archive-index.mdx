...
This is a snapshot of the manifest at the chapter's last-verified date. Stage 3 of the book's roadmap replaces this static listing with an auto-rendered page that reads from the manifest directly; until then, this page is maintained in parallel with the YAML and is subject to lag during the gap.

### T3-practitioner

**Sidenotes In Web Design** — Gwern Branwen, 2020. [gwern.net/sidenote](https://gwern.net/sidenote)
Captured 2026-04-17. Load-bearing for this book's sidenote design: Gwern's "no effort" principle (sidenotes should require no tap or click to reveal) shapes the mobile inline-flow pattern used throughout.

**Tufte CSS** — Dave Liepmann, 2014. [edwardtufte.github.io/tufte-css](https://edwardtufte.github.io/tufte-css/)
Captured 2026-04-17. Foundation for the two-column desktop layout with right-margin sidenotes, adapted with CSS custom properties for the book's warm Tol palette.
...
- **Auto-rendered archive page.** A dynamic Astro page reads the manifest at build time and replaces this static listing — including faceted filtering by tier, tool, and publish date.
