...
**Prevention:** incremental refactoring — extract one function, write characterization tests, refactor, verify, commit. Each step independently shippable. Characterization-test mechanics are covered in [Ch 5 Edit-Test-Commit](/05-edit-test-commit/); project-wide refactoring workflow will be covered in the starting-and-refactoring chapter (forthcoming).
